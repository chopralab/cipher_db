...
@pytest.mark.parametrize(
    "smi,true_score",
    [
        ("Cc1c(C(=O)NCCO)[n+](=O)c2ccccc2n1[O-]", 3.166),
        ("Cn1cc(NC=O)cc1C(=O)Nc1cc(C(=O)Nc2cc(C(=O)NCCC(N)=[NH2+])n(C)c2)n(C)c1", 3.328),
        ("OC(c1ccncc1)c1ccc(OCC[NH+]2CCCC2)cc1", 3.822),
        ("CC(C(=O)[O-])c1ccc(-c2ccccc2)cc1", 2.462),
        ("C[NH+](C)CC(O)Cn1c2ccc(Br)cc2c2cc(Br)ccc21", 3.577),
        ("NC(=[NH2+])NCC1COc2ccccc2O1", 3.290),
        ("CCC(C)(C)[NH2+]CC(O)COc1ccccc1C#N", 3.698),
        ("C[NH+](C)CC(O)Cn1c2ccc(Br)cc2c2cc(Br)ccc21", 3.577),
        ("CC12CCC3C(CCC4CC(=O)CCC43C)C1CCC2=O", 3.912),
        ("COc1ccc(OC(=O)N(CC(=O)[O-])Cc2ccc(OCCc3nc(-c4ccccc4)oc3C)cc2)cc1", 2.644),
        ("COc1ccccc1OC(=O)c1ccccc1", 1.342),
        ("CC(C)CC[NH2+]CC1COc2ccccc2O1", 3.701),
        ("CN1CCN(C(=O)OC2c3nccnc3C(=O)N2c2ccc(Cl)cn2)CC1", 3.196),
        ("CCC1(c2ccccc2)C(=O)N(COC)C(=O)N(COC)C1=O", 2.759),
        ("Nc1ccc(S(=O)(=O)Nc2ccccc2)cc1", 1.529),
        ("O=C([O-])CCCNC(=O)NC1CCCCC1", 2.493),
        ("CCC(C)C(C(=O)OC1CC[N+](C)(C)CC1)c1ccccc1", 3.399),
        ("CCC(C)SSc1ncc[nH]1", 3.983),
        ("CC[N+](C)(CC)CCOC(=O)C(O)(c1cccs1)C1CCCC1", 3.471),
        ("CC12CCC3C(CCC4CC(=O)CCC43C)C1CCC2O", 3.994),
        ("CC12CCC3C4CCC(=O)C=C4CCC3C1CCC2O", 4.056),
        ...
        ("C=CC[NH+]1CCCC1CNC(=O)c1cc(S(N)(=O)=O)cc(OC)c1OC", 4.286),
        ("CC(=O)OC1C[NH+]2CCC1CC2", 5.711),
        ("CC12CCC3C(CCC4CC(=O)CCC43C)C1CCC2O", 3.994),
        ...
        ("O=C([O-])CNC(=O)c1ccccc1", 2.097),
        ("Nc1ncnc2c1ncn2C1OC(COP(=O)([O-])OP(=O)([O-])OP(=O)([O-])[O-])C(O)C1O", 5.290),
        ("Nc1ncnc2c1ncn2C1OC(COP(=O)([O-])OP(=O)([O-])OP(=O)([O-])[O-])C(O)C1O", 5.290),
        ("c1ccc(OCc2ccc(CCCN3CCOCC3)cc2)cc1", 1.702),
        ("CC=CC1=C(C(=O)[O-])N2C(=O)C(NC(=O)C(N)c3ccc(O)cc3)C2SC1", 4.042),
        ("C[NH+]1CCCC1COc1cccnc1", 4.510),
        ("O=C([O-])C(O)CC(O)C(O)CO", 4.398),
        ("O=C([O-])C(O)CC(O)C(O)CO", 4.398),
        ("C[NH+]1CCCC1Cc1c[nH]c2ccc(CCS(=O)(=O)c3ccccc3)cc12", 3.921),
        ("C(=Cc1ccccc1)C[NH+]1CCN(C(c2ccccc2)c2ccccc2)CC1", 2.973),
        ("Nc1ncnc2c1ncn2C1OC(COP(=O)([O-])OP(=O)([O-])OP(=O)([O-])[O-])C(O)C1O", 5.290),
        ("CC(c1ccccc1)N(C)C=O", 2.562),
        ("CC(=O)C1CCC2C3CCC4CC(C)(O)CCC4(C)C3CCC12C", 4.279),
        ("O=C([O-])C(O)CC(O)C(O)CO", 4.398),
        ("COc1cc(O)c(C(=O)c2ccccc2)c(O)c1", 1.868),
        ("O=C([O-])C(O)CC(O)C(O)CO", 4.398),
        ("COc1c2c(cc3c1C(O)N(C)CC3)OCO2", 3.183),
        ("CCC(C(=O)[O-])c1ccc(CC(C)C)cc1", 2.827),
        ("O=C([O-])C1[NH+]=C(c2ccccc2)c2cc(Cl)ccc2NC1(O)O", 4.011),
        ("O=C([O-])C1[NH+]=C(c2ccccc2)c2cc(Cl)ccc2NC1(O)O", 4.011),
        ("OCC(O)COc1ccc(Cl)cc1", 2.102),
        ("NC(=O)NC(=O)C(Cl)c1ccccc1", 2.455),
        ("OC(c1ccccc1)(c1ccccc1)C1C[NH+]2CCC1CC2", 4.530),
        ("C[NH2+]CC(C)c1ccccc1", 3.471),
        ("Clc1cccc(Cl)c1N=C1NCCO1", 3.267),
        ("[NH3+]C(Cc1ccccc1)C(=O)CCl", 3.251),
        ("CC(C)Cn1cnc2c1c1ccccc1nc2N", 2.230),
        ("CC(O)CN(C)c1ccc(NN)nn1", 3.193),
        ("CC1(O)CCC2C3CCC4=CC(=O)CCC4=C3C=CC21C", 4.461),
        ...
        ("CC(=O)OCC1OC(n2ncc(=O)[nH]c2=O)C(OC(C)=O)C1OC(C)=O", 3.832),
        ("Cc1cccc(-c2nc3ccccc3c(Nc3ccc4[nH]ncc4c3)n2)n1", 2.358),
        ("O=C([O-])C1CC2CCCCC2[NH2+]1", 5.422),
        ("CC(=O)OCC(=O)C1CCC2C3CC=C4CC(O)CCC4(C)C3CCC12C", 4.187),
        ("O=C([O-])C1CC2CCCCC2[NH2+]1", 5.422),
        ("O=C(OCc1ccccc1)C(O)c1ccccc1", 2.038),
        ...
        ("O=C([O-])Cc1cc(=O)[nH]c(=O)[nH]1", 3.258),
        ("NC(=O)C([NH3+])Cc1c[nH]c2ccccc12", 3.224),
        ("NC(=O)C([NH3+])Cc1ccc(O)cc1", 3.280),
        ("O=C(c1cc2ccccc2o1)N1CCN(Cc2ccccc2)CC1", 1.799),
        ("O=C(CO)C(O)C(O)CO", 3.473),
        ("CC(Cc1ccccc1)NC(=O)C([NH3+])CCCC[NH3+]", 3.967),
        ...
        ("C[NH+]1C2CCC1CC(OC(=O)c1c[nH]c3ccccc13)C2", 4.892),
        ("Cc1ccccc1NC(=O)C(C)[NH+]1CCCC1", 3.809),
        ("O=S(=O)([O-])CCN1CCOCC1", 2.776),
        ("C[NH+]1CCN(CC(=O)N2c3ccccc3C(=O)Nc3cccnc32)CC1", 3.379),
        ("CCCCCC=CCC=CCCCCCCCC(=O)[O-]", 2.805),
        ("CC(CC([NH3+])C(=O)[O-])C(=O)[O-]", 5.690),
        ("CC1c2cccc(O)c2C(=O)C2=C(O)C3(O)C(O)=C(C(N)=O)C(=O)C([NH+](C)C)C3C(O)C21", 5.069),
        ("Cc1cc2nc3nc([O-])[nH]c(=O)c3nc2cc1C", 3.079),
        ("CC1=CC(C)C2(CO)COC(c3ccc(O)cc3)C1C2C", 4.749),
