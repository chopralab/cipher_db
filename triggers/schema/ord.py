...
# TODO: May need additional methods as I am not sure how the ORD fully
# functions with searching for reactions
...
def find_all_reactions_for_compound(inchikey, product=True, reactant=False):
    """Returns a list of reaction id of which the compound was involved as either a reactant and/or
    a product
